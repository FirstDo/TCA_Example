            ...
            VStack(alignment: .leading) {
                HStack {
                    ...
                    TextField(
                        ...
                        text: viewStore.binding(get: \.searchQuery, send: Search.Action.searchQueryChanged)
                    )
...
private func formattedWeatherDay(_ day: Search.State.Weather.Day, isToday: Bool) -> String {
    let date = isToday
    ? "Today"
